...
from pyiron_workflow_atomistics.calculator import fillin_default_calckwargs, generate_kwargs_variants, ase_calculate_structure_node_interface
...
def create_seg_structure_and_output_dir(structure: Atoms,
                                    defect_site: int,
                                    element: str,
...
def calculate_segregation_GB(wf,
                            structure: Atoms,
