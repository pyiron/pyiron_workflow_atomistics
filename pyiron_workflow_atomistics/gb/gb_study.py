...
@pwf.api.as_macro_node("final_pure_grain_boundary_structure",
...
def pure_gb_study(wf,
    ...
    wf.validate_static = validate_calculation_inputs(calculation_engine = static_calculation_engine,
    ...
    wf.calc_fn_calc_fn_kwargs = get_calc_fn_calc_fn_kwargs_from_calculation_engine(calculation_engine = calculation_engine,
                                                                                   structure = gb_structure,
                                                                                    calc_structure_fn = calc_structure_fn,
                                                                                    calc_structure_fn_kwargs = calc_structure_fn_kwargs)
    wf.static_calc_fn_calc_fn_kwargs = get_calc_fn_calc_fn_kwargs_from_calculation_engine(calculation_engine = static_calculation_engine,
                                                                                   structure = gb_structure,
                                                                                    calc_structure_fn = static_calc_structure_fn,
                                                                                    calc_structure_fn_kwargs = static_calc_structure_fn_kwargs)
    from pyiron_workflow_atomistics.utils import get_working_subdir_kwargs
    wf.calc_structure_fn_kwargs_gb_length_optimiser = get_working_subdir_kwargs(calc_structure_fn_kwargs=wf.calc_fn_calc_fn_kwargs.outputs.calc_fn_kwargs,
    ...
    wf.gb_with_vacuum = add_vacuum(wf.gb_length_optimiser.outputs.gb_structure_final,
                                ...
                                axis = gb_normal_axis)
    wf.calc_structure_fn_kwargs_gb_with_vacuum_rel = get_working_subdir_kwargs(calc_structure_fn_kwargs = wf.calc_fn_calc_fn_kwargs.outputs.calc_fn_kwargs,
                                                                        base_working_directory = wf.calc_fn_calc_fn_kwargs.outputs.calc_fn_kwargs["working_directory"],
    ...
    wf.gb_seg_supercell = create_supercell_with_min_dimensions(wf.gb_with_vacuum_rel.outputs.calc_output.final_structure, 
                                                            min_dimensions=min_inplane_cell_lengths)
    wf.calc_structure_fn_kwargs_gb_seg_supercell = get_working_subdir_kwargs(calc_structure_fn_kwargs = wf.calc_fn_calc_fn_kwargs.outputs.calc_fn_kwargs,
                                                                        base_working_directory = wf.calc_fn_calc_fn_kwargs.outputs.calc_fn_kwargs["working_directory"],
    ...
    wf.area = _get_area(wf.gb_with_vacuum_rel.outputs.calc_output.final_structure, gb_normal_axis)
    wf.surface_energy = _get_surface_energy(wf.gb_with_vacuum_rel.outputs.calc_output.final_energy, wf.gb_length_optimiser.outputs.gb_structure_final_energy, wf.area) 
    from pyiron_workflow_atomistics.gb.analysis import find_GB_plane, plot_GB_plane
    wf.gb_plane_extractor = find_GB_plane(atoms = wf.gb_with_vacuum_rel.outputs.calc_output.final_structure,
    ...
    wf.gb_plane_extractor_plot = plot_GB_plane(atoms = wf.gb_with_vacuum_rel.outputs.calc_output.final_structure,
    ...
    wf.calc_structure_fn_kwargs_cleavage_study = get_working_subdir_kwargs(calc_structure_fn_kwargs=wf.calc_fn_calc_fn_kwargs.outputs.calc_fn_kwargs,
                                                                          base_working_directory=wf.calc_fn_calc_fn_kwargs.outputs.calc_fn_kwargs["working_directory"],
                                                                          new_working_directory="cleavage_study")
    
    wf.calc_structure_fn_kwargs_cleavage_study_static = get_working_subdir_kwargs(calc_structure_fn_kwargs=wf.static_calc_fn_calc_fn_kwargs.outputs.calc_fn_kwargs,
    ...
    wf.CleaveGBStructureInput = modify_dataclass(CleaveGBStructure_Input, "cleavage_target_coord", wf.gb_plane_extractor.outputs.gb_plane_analysis_dict["gb_cart"])
    from pyiron_workflow_atomistics.gb.cleavage import rigid_and_relaxed_cleavage_study
    wf.cleavage_study = rigid_and_relaxed_cleavage_study(gb_structure = wf.gb_with_vacuum_rel.outputs.calc_output.final_structure,
                                       gb_structure_energy = wf.gb_with_vacuum_rel.outputs.calc_output.final_energy,
                                       gb_plane_cart_loc = wf.gb_plane_extractor.outputs.gb_plane_analysis_dict["gb_cart"],
                                       calc_structure_fn = wf.calc_fn_calc_fn_kwargs.outputs.calc_fn,
    ...
    wf.min_rigid_cleavage_energy = get_min_energy_from_cleavage_study(wf.cleavage_study.outputs.cleavage_results_rigid)
    wf.min_relaxed_cleavage_energy = get_min_energy_from_cleavage_study(wf.cleavage_study.outputs.cleavage_results_relax)
    return  wf.gb_length_optimiser.outputs.gb_structure_final,\
